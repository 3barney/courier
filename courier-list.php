...
$sql = "SELECT cid, cons_no, ship_name, rev_name, pick_date, pick_time, status, destination
		FROM tbl_courier
...
<table border="0" align="center" width="80%">
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF">
      <td class="newtext" bgcolor="#EDEDED" width="6%" style="height: 20px"><div align="center">Edit</div></td>
      <td class="newtext" bgcolor="#EDEDED" width="10%" style="height: 20px">Consignment No </td>
      <td class="newtext" bgcolor="#EDEDED" width="7%" style="height: 20px">Shipper</td>
      <td class="newtext" bgcolor="#EDEDED" width="11%" style="height: 20px">Receiver</td>
      <td class="newtext" bgcolor="#EDEDED" width="11%" style="height: 20px">Pickup Date/Time</td>
      <td class="newtext" bgcolor="#EDEDED" width="9%" style="height: 20px">Status</td>
       <td class="newtext" bgcolor="#EDEDED" width="9%" style="height: 20px">Destination</td>
    </tr>
	<?php
	...
	?>
      ...
      <td class="gentxt"><?php echo $status; ?></td>
       <td class="gentxt"><?php echo $destination; ?></td>
    </tr>
    <?php
	}//while
	?>
